...
#include "basis.hpp"   /* wegen size_t, NULL, malloc, free, calloc,   */
                       /*       boolean, FALSE, TRUE, REAL, mat4x4    */
#include "vmblock.hpp" /* wegen vmalloc, vmcomplete, vmfree, vminit,  */
                       /*       VEKTOR, VVEKTOR, MATRIX, IMATRIX,     */
                       /*       MMATRIX, UMATRIX, PMATRIX             */


//-> GEAENDERT: wegen Qt-enum-ambiguity
/** @def QGLOBAL_H geaendert wegen Qt-enum-Mehrdeutigkeit */
#ifdef QGLOBAL_H
 #undef boolean
 #undef TRUE
 #undef FALSE
...
//-> GEAENDERT: wegen Qt-enum-ambiguity
/** @typedef geaendert wegen Qt-enum-Mehrdeutigkeit */
...
#ifndef FAST_ALLOC              /* sichere, aber teuere Allokation?   */
#define matmalloc(mat, m, n, typ, umat) { size_t j, k; if ((mat = (typ **)calloc((m), sizeof(typ *))) != NULL) for (j = 0; j < (m); j++) { k = (umat) ? (j + 1) : (n); if ((((typ **)mat)[j] = (typ *)calloc(k, sizeof(typ))) == NULL) { matfree((void **)(mat), j); mat = NULL; break; } } }

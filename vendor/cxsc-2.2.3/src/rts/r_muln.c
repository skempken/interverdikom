...
/* CVS $Id: r_muln.c,v 1.12 2008/01/23 08:39:42 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : r_muln.c                              */
/*                                                              */
/*      Entries         : a_real r_muln(a,b)                    */
/*                        a_real a,b;                           */
/*                                                              */
...
#ifdef LINT_ARGS
local a_real r_muln(a_real a,a_real b)
#else
local a_real r_muln(a,b)
...
#include "mulbody.h"
        ...
        /* rounding                                             */
        if (rc==NO_ERROR) rc = b_rndn( lang, &expoc );
        else (void)b_rndn( lang, &expoc );

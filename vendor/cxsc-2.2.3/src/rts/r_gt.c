...
/* CVS $Id: r_gt.c,v 1.11 2008/01/23 08:39:42 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : r_gt.c                                */
/*                                                              */
/*      Entries         : a_bool r_gt(a,b)                      */
/*                        a_real a,b;                           */
/*                                                              */
...
#ifdef LINT_ARGS
local a_bool r_gt(a_real a,a_real b)
#else
local a_bool r_gt(a,b)
...
a_real b;
        ...
        else if (zeroa) res = (zerob) ? FALSE : vzb;

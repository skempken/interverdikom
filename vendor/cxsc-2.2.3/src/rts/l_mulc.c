...
/* CVS $Id: l_mulc.c,v 1.11 2008/01/23 08:39:41 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : l_mulc.c                              */
/*                                                              */
/*      Entries         : multiprecision l_mulc(i1,i2)          */
...
#ifdef LINT_ARGS
local multiprecision l_mulc(multiprecision i1,multiprecision i2)
#else
local multiprecision l_mulc(i1,i2)

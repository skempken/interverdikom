...
/* CVS $Id: r_mulu.c,v 1.12 2008/01/23 08:39:42 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : r_mulu.c                              */
/*                                                              */
/*      Entries         : a_real r_mulu(a,b)                    */
/*                        a_real a,b;                           */
/*                                                              */
...
#ifdef LINT_ARGS
local a_real r_mulu(a_real a,a_real b)
#else
local a_real r_mulu(a,b)
...
#include "mulbody.h"
        ...
        /* rounding                                             */
        if (rc==NO_ERROR) rc = b_rndu( lang, &expoc, vzc );
        else (void)b_rndu( lang, &expoc, vzc );

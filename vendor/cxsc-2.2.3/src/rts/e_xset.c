...
/* CVS $Id: e_xset.c,v 1.11 2008/01/23 08:39:41 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : e_xset.c                              */
/*                                                              */
/*      Entry           : void e_xset(code,e_argc,e_argv)       */
/*                        a_btyp code;                          */
/*                        va_list e_argv;                       */
/*                                                              */
...
#ifdef LINT_ARGS
local void e_xset(a_btyp code,int e_argc,va_list e_argv)
#else
local void e_xset(code,e_argc,e_argv)

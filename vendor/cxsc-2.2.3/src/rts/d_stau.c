...
/* CVS $Id: d_stau.c,v 1.11 2008/01/23 08:39:40 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : d_stau.c                              */
/*                                                              */
/*      Entries         : a_real d_stau(a)                      */
/*                        d_otpr a;                             */
/*                                                              */
/*      Arguments       : a = dotprecision variable             */
/*                                                              */
/*      Description     : Round dotprecision variable to        */
/*                        nearest IEEE double value greater than*/
...
#ifdef LINT_ARGS
local a_real d_stau(d_otpr a)
#else
local a_real d_stau(a)
...
d_otpr a;
        ...
        /* get accu value in IEEE length                        */
           ...
           if ( (rc = b_adj( lang, &expo )) ==NO_ERROR)
              rc = b_rndu( lang, &expo, vz );
           else
              (void)b_rndu( lang, &expo, vz );

...
/* CVS $Id: f_popt.c,v 1.11 2008/01/23 08:39:41 cxsc Exp $ */
...
/*                        string variable.                      */
/*                        Only those arguments are returned     */
/*                        that are not processed by PASCAL-xsc. */
/*                                                              */
/****************************************************************/
...
s_trng *d;
        ...
        if ((arglen = strlen(f_argv[index]))==0)
           {
           d->clen = 0;
           }
...
b_geth((a_char *)&d->ptr,(a_char *)d->ptr,(a_char *)"s_asgn");
           ...
           /* destination is not dynamic == chopping */
              ...
              {
              memcpy(d->ptr,f_argv[index],d->alen);
              d->clen = d->alen;
              }
           }

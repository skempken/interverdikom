...
/* CVS $Id: z_dadd.c,v 1.11 2008/01/23 08:39:43 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : z_dadd.c                              */
/*                                                              */
/*      Entries         : void z_dadd(ZRI,ZII,ZRS,ZIS,A)        */
...
#ifdef LINT_ARGS
local void z_dadd(dotprecision *ZRI,dotprecision *ZII,dotprecision *ZRS,
                  dotprecision *ZIS,d_otpz A)
#else
local void z_dadd(ZRI,ZII,ZRS,ZIS,A)

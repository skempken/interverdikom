...
/* CVS $Id: t_tan.c,v 1.11 2008/01/23 08:39:43 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : t_tan.c                               */
/*                                                              */
/*      Entries         : a_real t_tan(arg)                     */
/*                        a_real arg;                           */
/*                                                              */
/*      Arguments       : arg  = argument of tangent            */
/*                                                              */
...
/* StdFctReal(t_tan,tanee) */
#ifdef LINT_ARGS
a_real t_tan(a_real arg)
#else
a_real t_tan(arg)
...
#ifdef ANSI_C
#ifdef LINT_ARGS
int tanee(const ExtReal *arg, ExtReal *res)
#else
int tanee(arg, res)
const ExtReal   *arg;
      ExtReal   *res;
...
#else  /* NOT ANSI_C */
#ifdef LINT_ARGS
int tanee(ExtReal *arg, ExtReal *res)
#else
int tanee(arg, res)
ExtReal   *arg;
ExtReal   *res;
...
#endif /* ANSI_C */
{
   ...
   /* --- pruefe Argument --- */
   ArgCheck1(Tan, arg, res);

   /* --- ganzzahliger Anteil von arg --- */
   gza_trg(arg, J_Init_Tan, Period_PiQuart, &v, &j, &jmod4);

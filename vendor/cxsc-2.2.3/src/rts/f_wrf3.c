...
/* CVS $Id: f_wrf3.c,v 1.11 2008/01/23 08:39:41 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : f_wrf3.c                              */
/*                                                              */
/*      Entry           : void f_wrf3(desc,r,w,f)               */
/*                        FILE *desc;                           */
/*                        real r;                               */
/*                        a_intg w;                             */
/*                        a_intg f;                             */
...
#ifdef LINT_ARGS
local void f_wrf3(f_text *desc,a_real r,a_intg w,a_intg f)
#else
local void f_wrf3(desc,r,w,f)

...
/* CVS $Id: t_ehl1.c,v 1.11 2008/01/23 08:39:43 cxsc Exp $ */
...
/*--------------------------------------------------------------*
 | Exception Handle PunktFunktionen mit einem Argument          |
 *--------------------------------------------------------------*/
#ifdef ANSI_C
#ifdef LINT_ARGS
int exc_handle_1(int fct, int exctype, const ExtReal *arg, ExtReal *res)
#else
int exc_handle_1(fct, exctype, arg, res)
...
#else  /* NOT ANSI_C */
#ifdef LINT_ARGS
int exc_handle_1(int fct, int exctype, ExtReal *arg, ExtReal *res)
#else
int exc_handle_1(fct, exctype, arg, res)
int      fct;              /* FunktionsNummer                   */
int      exctype;          /* ExceptionNummer                   */
...
#endif /* ANSI_C */
{
   ...
   default_handle_1(fct, exctype, arg, &ir.u);
 ...
 /*  msg_exc("arg", arg);
   ...
   /* --- kopiere default Antwort nach res
          (erst hier, falls arg==res) --- */
   copyee(&ir.u, res);

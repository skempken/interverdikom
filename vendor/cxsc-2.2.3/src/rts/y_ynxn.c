...
/* CVS $Id: y_ynxn.c,v 1.11 2008/01/23 08:39:43 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : y_ynxn.c                              */
/*                                                              */
/*      Entry           : a_VOID y_ynxn(d,e_args)               */
/*                        y_dscp d;                             */
/*                        e_list                                */
/*                                                              */
...
#ifdef LINT_ARGS
#if C_P_7
local a_VOID y_ynxn(y_dscp d,...)
#else
local a_VOID y_ynxn(d,e_args)
...
e_list
        ...
        for (i=0;i<((y_desc *)d)->numdim;i++)
           ...
           v += e_ref(a_intg)*((y_desc *)d)->fd[i].stride;

...
/* CVS $Id: e_xiob.c,v 1.11 2008/01/23 08:39:40 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : e_xiob.c                              */
/*                                                              */
/*      Entry           : void e_xiob(code,e_argc,e_argv)       */
/*                        a_btyp code;                          */
/*                        va_list e_argv;                       */
/*                                                              */
...
/*                                                              */
/*      Description     : Insufficient buffer size.             */
/*                                                              */
/****************************************************************/
...
#ifdef LINT_ARGS
local void e_xiob(a_btyp code,int e_argc,va_list e_argv)
#else
local void e_xiob(code,e_argc,e_argv)

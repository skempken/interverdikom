...
/* CVS $Id: l_subu.c,v 1.11 2008/01/23 08:39:41 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : l_subu.c                              */
/*                                                              */
/*      Entries         : multiprecision l_subu(i1,i2)          */
...
#ifdef LINT_ARGS
local multiprecision l_subu(multiprecision i1,multiprecision i2)
#else
local multiprecision l_subu(i1,i2)

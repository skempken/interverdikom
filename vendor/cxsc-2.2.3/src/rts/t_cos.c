...
/* CVS $Id: t_cos.c,v 1.11 2008/01/23 08:39:43 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : t_cos.c                               */
/*                                                              */
/*      Entries         : a_real t_cos(arg)                     */
/*                        a_real arg;                           */
/*                                                              */
/*      Arguments       : arg  = argument of cosine             */
/*                                                              */
...
/* StdFctReal(t_cos,cosee) */
#ifdef LINT_ARGS
a_real t_cos(a_real arg)
#else
a_real t_cos(arg)
...
#ifdef ANSI_C
#ifdef LINT_ARGS
int cosee(const ExtReal *arg, ExtReal *res)
#else
int cosee(arg, res)
const ExtReal  *arg;
      ExtReal  *res;
...
#else  /* NOT ANSI_C */
#ifdef LINT_ARGS
int cosee(ExtReal *arg, ExtReal *res)
#else
int cosee(arg, res)
ExtReal  *arg;
ExtReal  *res;
...
#endif /* ANSI_C */
{
   ...
   /* --- pruefe Argument --- */
   ArgCheck1(Cos, arg, res);

   /* --- ganzzahliger Anteil von arg --- */
   gza_trg(arg, J_Init_Cos, Period_PiHalf, &v, &j, &jmod4);

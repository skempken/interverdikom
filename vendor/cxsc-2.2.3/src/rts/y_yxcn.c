...
/* CVS $Id: y_yxcn.c,v 1.11 2008/01/23 08:39:43 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : y_yxcn.c                              */
/*                                                              */
/*      Entry           : a_VOID y_yxcn(d,e_args)               */
/*                        y_dscp d;                             */
/*                        e_list                                */
/*                                                              */
...
#ifdef LINT_ARGS
#if C_P_7
local a_VOID y_yxcn(y_dscp d,...)
#else
local a_VOID y_yxcn(d,e_args)
...
e_list
        ...
        for (i=0;i<((y_desc *)d)->numdim;i++)
           ...
           k = e_ref(a_intg);
           if (k<0 || k>((y_desc *)d)->fd[i].ubound-
				    ((y_desc *)d)->fd[i].lbound)
              {

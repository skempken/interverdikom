...
/* CVS $Id: z_psub.c,v 1.11 2008/01/23 08:39:43 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : z_psub.c                              */
/*                                                              */
/*      Entries         : void z_psub(crl,cil,cru,ciu,a,b)      */
...
#ifdef LINT_ARGS
local void z_psub(dotprecision *crl,dotprecision *cil,dotprecision *cru,
                  dotprecision *ciu,a_cinv a,a_cinv b)
#else
local void z_psub(crl,cil,cru,ciu,a,b)
...
a_cinv b;
        ...
        i_psub(crl,cru,a.RE,b.RE);
        i_padd(crl,cru,a.IM,b.IM);
        i_psub(cil,ciu,a.RE,b.IM);
        i_psub(cil,ciu,a.IM,b.RE);

...
/* CVS $Id: d_stad.c,v 1.11 2008/01/23 08:39:40 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : d_stad.c                              */
/*                                                              */
/*      Entries         : a_real d_stad(a)                      */
/*                        d_otpr a;                             */
/*                                                              */
/*      Arguments       : a = dotprecision variable             */
/*                                                              */
/*      Description     : Round dotprecision variable to        */
/*                        nearest IEEE double value less than   */
/*                        or equal to exact value               */
/*                                                              */
/****************************************************************/
...
#ifdef LINT_ARGS
local a_real d_stad(d_otpr a)
#else
local a_real d_stad(a)
...
d_otpr a;
        ...
        /* get accu value in IEEE length                        */
           ...
           {
           R_ASSIGN(res,
              ((a[A_STATUS] & A_PZERO)==ZERO) ? *r_zero : *r_sero);
           }
        else
           {
           ...
           if ( (rc = b_adj( lang, &expo )) ==NO_ERROR)
               rc = b_rndd( lang, &expo, vz );
           else
               (void)b_rndd( lang, &expo, vz );

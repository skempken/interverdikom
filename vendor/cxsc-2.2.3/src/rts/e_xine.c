...
/* CVS $Id: e_xine.c,v 1.11 2008/01/23 08:39:40 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : e_xine.c                              */
/*                                                              */
/*      Entry           : void e_xine(code,e_argc,e_argv)       */
/*                        a_btyp code;                          */
/*                        va_list e_argv;                       */
/*                                                              */
...
#ifdef LINT_ARGS
local void e_xine(a_btyp code,int e_argc,va_list e_argv)
#else
local void e_xine(code,e_argc,e_argv)
...
va_list e_argv;
        ...
        if (code & E_IEEE)
           ...
           {
           if ((print = ((code & (E_EMSG+E_EXIT)) ? TRUE : FALSE))==TRUE)
              e_tmsg(8);

...
/* CVS $Id: d_eq.c,v 1.11 2008/01/23 08:39:40 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : d_eq.c                                */
/*                                                              */
/*      Entries         : a_bool d_eq(a,b)                      */
/*                        dotprecision a,b;                     */
/*                                                              */
...
#ifdef LINT_ARGS
local a_bool d_eq(dotprecision a,dotprecision b)
#else
local a_bool d_eq(a,b)
...
dotprecision b;
        ...
        if (a[A_BEGIN]==ZERO)
           {
           res = (b[A_BEGIN]==ZERO) ? TRUE : FALSE;
           }
        else if (b[A_BEGIN]==ZERO) res = FALSE;
        else
           {

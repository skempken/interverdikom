...
/* CVS $Id: d_lt.c,v 1.11 2008/01/23 08:39:40 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : d_lt.c                                */
/*                                                              */
/*      Entries         : a_bool d_lt(a,b)                      */
/*                        dotprecision a,b;                     */
/*                                                              */
...
#ifdef LINT_ARGS
local a_bool d_lt(dotprecision a,dotprecision b)
#else
local a_bool d_lt(a,b)
           ...
           if (a[A_SIGN]<b[A_SIGN]) res = FALSE;
              ...
              if (a[A_BEGIN]<b[A_BEGIN]) res = FALSE;
                 ...
                 if (i>a[A_END] || i>b[A_END])
                    res = (b[A_END]<a[A_END]) ? TRUE : FALSE;
                 }
              }
           else
              {

...
/* CVS $Id: s_ixcn.c,v 1.11 2008/01/23 08:39:42 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : s_ixcn.c                              */
/*                                                              */
/*      Entry           : a_char *s_ixcn(s,i)                   */
/*                        s_trng *s;                            */
/*                        a_intg i;                             */
/*                                                              */
...
#ifdef LINT_ARGS
local a_char *s_ixcn(s_trng *s,a_intg i)
#else
local a_char *s_ixcn(s,i)
...
#ifdef HEAP_CHECK
b_freh((a_char *)&s->ptr,(a_char *)s->ptr,(a_char *)"s_ixcn");
#endif
                    B_FREE(s->ptr)
                    }
#ifdef HEAP_CHECK
b_geth((a_char *)&s->ptr,(a_char *)ptr,(a_char *)"s_ixcn");
#endif
                 s->ptr = ptr;
                 s->alen = (size_t) i;

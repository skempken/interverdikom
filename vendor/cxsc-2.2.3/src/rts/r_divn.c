...
/* CVS $Id: r_divn.c,v 1.12 2008/01/23 08:39:42 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : r_divn.c                              */
/*                                                              */
/*      Entries         : a_real r_divn(a,b)                    */
/*                        a_real a,b;                           */
/*                                                              */
...
#ifdef LINT_ARGS
local a_real r_divn(a_real a,a_real b)
#else
local a_real r_divn(a,b)
...
#include "divbody.h"
        ...
        /* rounding                                             */
        if (rc==NO_ERROR) rc = b_rndn( mantc, &expoc );
        else (void)b_rndn( mantc, &expoc );

...
/* CVS $Id: l_subd.c,v 1.11 2008/01/23 08:39:41 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : l_subd.c                              */
/*                                                              */
/*      Entries         : multiprecision l_subd(i1,i2)          */
/*                        multiprecision i1,i2;                 */
/*                                                              */
/*      Description     : Subtraction of multi-precision numbers*/
/*                        with rounding downwards.              */
/*                                                              */
/****************************************************************/
...
#ifdef LINT_ARGS
local multiprecision l_subd(multiprecision i1,multiprecision i2)
#else
local multiprecision l_subd(i1,i2)

...
/* CVS $Id: l_pred.c,v 1.11 2008/01/23 08:39:41 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Filename        : l_pred.c                              */
/*                                                              */
/*      Entries         : multiprecision l_pred(a)              */
/*                        multiprecision a;                     */
/*                                                              */
/*      Description     : Predecessor of multiprecision value   */
...
#ifdef LINT_ARGS
local multiprecision l_pred(multiprecision a)
#else
local multiprecision l_pred(a)

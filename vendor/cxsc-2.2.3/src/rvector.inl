...
/* CVS $Id: rvector.inl,v 1.13 2008/01/23 08:39:32 cxsc Exp $ */
...
namespace cxsc {
	...
	*/
	...
	INLINE const real & rvector_slice::operator [](const int &i) const
#if(IndCheck)
		throw(ERROR_RVECTOR_ELEMENT_NOT_IN_VEC)
#else
	throw()
	...
	INLINE const real & rvector::operator [](const int &i) const
#if(IndCheck)
		throw(ERROR_RVECTOR_ELEMENT_NOT_IN_VEC)
#else
	throw()

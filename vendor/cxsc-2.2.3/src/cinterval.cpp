...
/* CVS $Id: cinterval.cpp,v 1.8 2008/01/23 08:39:29 cxsc Exp $ */
...
cinterval operator *(const cinterval & a,const cinterval & b) throw()
{
   cidotprecision akku;
   akku=0.0;
   accumulate(akku,a,b);
...
cinterval operator / (const cinterval & a, const cinterval & b) throw(DIV_BY_ZERO)
{

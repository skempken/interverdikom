...
/* CVS $Id: interval.hpp,v 1.31 2008/05/28 17:58:39 cxsc Exp $ */
...
//      friend inline interval _interval(const idotprecision &a) throw() { return interval(a); }
      ...
      friend     interval operator /(const interval &,const interval &) throw(DIV_BY_ZERO);
...
//             inline      operator void*(void) const throw() { return (void*)(!(!*this)); } 
      ...
      friend inline       real & Inf (interval& a)       throw();
      //! Returns the infimum of an interval
      friend inline const real & Inf (const interval &a) throw();
      //! Returns the supremum of an interval
      friend inline       real & Sup (interval& a)       throw();
      //! Returns the supremum of an interval
      friend inline const real & Sup (const interval &a) throw();
      
      //! Returns the interval with the new given infimum value
      friend inline interval& SetInf (interval& a, const real& b) throw();
      //! Returns the interval with the new given supremum value
      friend inline interval& SetSup (interval& a, const real& b) throw();
      //! Returns the interval with the unchecked new given infimum value
      friend inline interval& UncheckedSetInf (interval& a, const real& b) throw();
      //! Returns the interval with the unchecked new given supremum value
      friend inline interval& UncheckedSetSup (interval& a, const real& b) throw();
      ...
      friend inline void times2pown(interval& x, const int& n) throw(); // Blomquist, 28.11.02
};

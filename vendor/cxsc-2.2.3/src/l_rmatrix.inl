...
/* CVS $Id: l_rmatrix.inl,v 1.7 2008/01/23 08:39:31 cxsc Exp $ */
...
INLINE l_rmatrix::l_rmatrix(const rvector_slice &v) throw():lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	...
	INLINE l_rmatrix_subv l_rmatrix_slice::operator [](const int &i)
#if(IndCheck)
		throw(ERROR_LRMATRIX_ROW_OR_COL_NOT_IN_MAT)
#else
	throw()
	...
	INLINE l_rmatrix_subv l_rmatrix_slice::operator [](const cxscmatrix_column &i)
#if(IndCheck)
		throw(ERROR_LRMATRIX_ROW_OR_COL_NOT_IN_MAT)
#else
	throw()

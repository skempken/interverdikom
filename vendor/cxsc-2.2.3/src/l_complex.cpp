...
*/
/* CVS $Id: l_complex.cpp,v 1.9 2008/01/23 08:39:31 cxsc Exp $ */
    ...
    throw()
{
    l_real r, i; 
    dotakku[0] = 0;
    accumulate(dotakku[0],a.re,b.re);
    accumulate(dotakku[0],-a.im,b.im);
    r = dotakku[0];
    dotakku[0] = 0;
    accumulate(dotakku[0],a.im,b.re);
    accumulate(dotakku[0],a.re,b.im);
    i = dotakku[0];
    ...
    throw()
{
    l_real r, i; 
    dotakku[0] = 0;
    accumulate(dotakku[0],a.re,Re(b));
    accumulate(dotakku[0],-a.im,Im(b));
    r = dotakku[0];  // r is real-part
    dotakku[0] = 0;
    accumulate(dotakku[0],a.im,Re(b));
    accumulate(dotakku[0],a.re,Im(b));
    i = dotakku[0];  // i is imaginary part
    return( l_complex(r,i) );
}

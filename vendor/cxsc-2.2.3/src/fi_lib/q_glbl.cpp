...
/* CVS $Id: q_glbl.cpp,v 1.7 2008/01/23 08:39:36 cxsc Exp $ */

/****************************************************************/
/*                                                              */
/*      Description     : Constants for fast real functions     */
/*                        for real   IEEE Floating-Point        */
/*                        Arithmetic                            */
/*                                                              */
/*      Date            : 1997-06-10                            */
/*                                                              */
...
/*        q_minr   = smallest positive normalised number                 */
   real   q_minr   = 2.2250738585072013e-308; 
/*        q_mine   = ln( q_minr ) = -708.3964185322641062617539          */
   real   q_mine   = -6231120794008786.0 / 8796093022208.0;
/*        q_sqra   = 1.3407807929942596e154;                             */
   real   q_sqra   = 1.3407807929942596e154;
/*        q_ctht   = 5.562684646268013e-309;                             */
   real   q_ctht   = 5.562684646268013e-309;

/*        q_ln2h   = ln( 2.0 ) / 2 = 0.346573590279972654708616          */
   real   q_ln2h   = 6243314768165359.0 / 18014398509481984.0;
/*        q_l10i   =  1 / ln( 10 ) = 4.342944819032518E-001              */ 
   real   q_l10i   = 7823553867474190.0 / 18014398509481984.0;
/*        q_l2i    =  1 / ln( 2 )  = 1.442695040888963E+000              */ 
   real   q_l2i    = 6497320848556798.0 / 4503599627370496.0;
/*        q_l10    = ln( 10 ) = 2.302585092994046E+000                   */ 
   real   q_l10    = 5184960683398422.0 / 2251799813685248.0;
/*        q_l2     = ln( 2 ) = 6.931471805599453E-001                    */ 
   real   q_l2     = 6243314768165359.0 / 9007199254740992.0;

/*        q_p2h    = 2^(100)                                             */
   real   q_p2h    = 1267650600228229401496703205376.0; 
/*        q_p2mh   = 2^(-100)                                            */
   real   q_p2mh   = 1.0/1267650600228229401496703205376.0;

/*        q_pi     = pi   ( rounding towards -infinity )                 */
   real   q_pi     = 7074237752028440.0 / 2251799813685248.0;
/*        q_piha   = pi/2                                                */ 
   real   q_piha   = 7074237752028440.0 / 4503599627370496.0;  
...
/*        q_pi2i   = 2/pi                                                */
   real   q_pi2i   = 5734161139222659.0 / 9007199254740992.0;
/*        q_pi2p[3]=                                                     */
   real   q_pi2p[3]={
...
// nu_ko_1 = 2/sqrt(pi):
   real nu_ko_1 = 5081767996463981.0 / 4503599627370496.0;
...
/*        q_ext1 = 5.551115123125783E-017                                */
   real   q_ext1 = 4503599627370496.0 / 81129638414606681695789005144064.0;
/*        q_ext2 = 1.809114141261457E+003                                */
   real   q_ext2 = 7956568137163861.0 / 4398046511104.0;
/*        q_ex2a = 7.097827128933840E+002                                */
   real   q_ex2a = 6243314768165359.0 / 8796093022208.0;   
/*        q_ex2b =-744.44008                                            */
   real   q_ex2b =-6548164193139965.0 / 8796093022208.0;  
/*        q_ex2c = 7.090895657128240E+002                                */
   real   q_ex2c = 6237217781087072.0 / 8796093022208.0;   
/*        q_ext3 =-3.742994775023704E+001                                */
   real   q_ext3 =-5267796835639521.0 / 140737488355328.0;
/*        q_ext4 =-2.876820724517810E-001                                */
   real   q_ext4 =-5182419497180051.0 / 18014398509481984.0;
/*        q_ext5 = 2.231435513142098E-001                                */
   real   q_ext5 = 8039593716390434.0 / 36028797018963968.0;
/*        q_extm = 307.9536855642527627036                               */
   real   q_extm = 5417578529509920.0 / 17592186044416.0;
/*        q_extn =-307.65265556858878150844                               */
   real   q_extn =-5412282753821250.0 / 17592186044416.0;

/*        q_exil = 4.616624130844683E+001                                */
   real   q_exil = 6497320848556798.0 / 140737488355328.0;
/*        q_exl1 = 2.166084939017310E-002                                */
   real   q_exl1 = 6243314767495168.0 / 288230376151711744.0;
/*        q_exl2 = 2.325192846878874E-012                                */
   real   q_exl2 = 5756898648422637.0 / 2475880078570760549798248448.0;
/*        q_e10i = 32/lg10(2) = 1.063016990363956E+002                   */
   real   q_e10i = 7480317065143153.0 / 70368744177664.0;
/*        q_e1l1 = lg10(2)/32 ( lead )  = 9.407187363649427E-003         */
   real   q_e1l1 = 5422874304708608.0 / 576460752303423488.0;
/*        q_e1l2 = lg10(2)/32 ( trail ) = 8.499849253130399E-013         */
   real   q_e1l2 = 8417842974672045.0 / 9903520314283042199192993792.0;
...
/* qLogT1= 9.394130628134757E-001 */
   real   q_lgt1= 8461480639267491.0 / 9007199254740992.0;
/* qLogT2= 1.064494458917860E+000 */
   real   q_lgt2= 4794056848520430.0 / 4503599627370496.0;
/* qLogT3=-6.058693718652422E-002 */
   real   q_lgt3=-8731497847576004.0 / 144115188075855872.0;
/* qLogT4= 6.449445891785943E-002 */
   real   q_lgt4= 4647315538398936.0 / 72057594037927936.0;
/* qLogT5= 2^-53 = 1.110223024625157E-016 */
   real   q_lgt5= 4503599627370496.0 / 40564819207303340847894502572032.0;
/* qLogT6= 2^55 = 3.60287970189639680E+016 */
   real   q_lgt6= 3.60287970189639680E+016;
...
/* --------------------------------------------------------------------- */
   ...
   real   q_atnt=1.807032e-8; /* for |x|<=q_atnt approx. x=arctan(x)     */
...
/* --------------------------------------------------------------------- */
    ...
    real   q_at3i = 6004799503160661.0 / 18014398509481984.0;
...
// Die folgenden Konstanten q_erf_m,q_erf_p beziehen sich 
// auf eps(erf) = 6.36761e-16;
 real q_erf_m = 9007199254740984.0 / 9007199254740992.0; // <1
 real q_erf_p = 4503599627370500.0 / 4503599627370496.0; // >1

// Die folgenden Konstanten q_erfc_m, q_erfc_p beziehen sich 
// auf eps(erfc) = 1.3269E-15     und  -MaxReal <= x <=26.5;
 real q_erfc_m = 9007199254740978.0 / 9007199254740992.0; // <1
 real q_erfc_p = 4503599627370503.0 / 4503599627370496.0; // >1

// *************************************************************************
// *                Konstanten fuer erf(x) und erfc(x):                    *
// *************************************************************************

 real q_erfa1 = 1.97193e-308; // Diese Intervallgrenze ist groß genug!

 real q_erfx0 = 4503621633481514.0 / 9007199254740992.0; // Dies ist 
// die Mantisse von erf(q_erfa1);

// Die folgenden Konstante  q_erfc_1  ist die aufgerundete Mantisse
// des Maschinenwertes  erfc(26.5)
 real q_erfc_1 = 5593658663767294.0 / 9007199254740992.0;

// *************************************************************************

// Koeffizienten des Kettenbruchs K_4(v) für erf(x) in A=[0,0.5]:
 real q_erfa3_a[5] = {0.0, 
			   -6775690661951386.0 / 18014398509481984.0, 
			   +5352849914272181.0 / 288230376151711744.0, 
			   +7189941058485534.0 / 576460752303423488.0, 
                           +7296993996455191.0 / 1152921504606846976.0 };

 real q_erfa3_b[5] = {5081767996463981.0 / 4503599627370496.0,
                           5404319552708905.0 / 18014398509481984.0, 
                           7636888806912242.0 / 72057594037927936.0, 
                           7777809447639629.0 / 576460752303423488.0, 
                           8055811704679260.0 / 18014398509481984.0 };

// Koeffizienten des Kettenbruchs K_7(v) für erf_b(x), x in B=[0.5,1.125]:
 real q_erfb_a[8] = {0.0, 
			  6199208649805955.0 / 9007199254740992.0,
                          8973480898164999.0 / 18014398509481984.0,
                          6344938805644507.0 / 72057594037927936.0,
                          8362671364366071.0 / 36028797018963968.0,
                          -5022191033015856.0 / 1152921504606846976.0,
                          6322514500164442.0 / 562949953421312.0,
                          -6435634224922073.0 / 144115188075855872.0 };
 real q_erfb_b[8] = { 6124505500765635.0 / 9007199254740992.0,
                           6333186975989797.0 / 9007199254740992.0,
                           -8475979040495454.0 / 36028797018963968.0,
                           -8572590926147918.0 / 18014398509481984.0,
                           8937333370520808.0 / 36028797018963968.0,
			   -6834660987538410.0 / 2251799813685248.0,
			   8088337318799409.0 / 2251799813685248.0,
                           -8319905429262301.0 / 18014398509481984.0 };
 real q_erfB_x0 = 45.0/64.0;

// Koeffizienten des Kettenbruchs K_6(v) für erf_c(x), x in C=[1.125,1.75]:
 real q_erfc_a[7] = {0.0, 
			  6137857706384139.0 / 36028797018963968.0,
			  8678811781912586.0 / 9007199254740992.0,
			  7734682891265768.0 / 36028797018963968.0,
			  8140094813613413.0 / 72057594037927936.0,
			  7138480065533395.0 / 144115188075855872.0,
			  4776523035408743.0 / 36028797018963968.0 };
 real q_erfc_b[7] = { 8540356772930556.0 / 9007199254740992.0,
			   6192449487634516.0 / 4503599627370496.0,
			   -8569011182787169.0 / 36028797018963968.0,
			   -8195808711791432.0 / 36028797018963968.0,
			   -5840393326308518.0 / 36028797018963968.0,
			   -6093224718252872.0 / 18014398509481984.0,
                           5254280044278263.0 / 36028797018963968.0 };
 real q_erfC_x0 = 11.0 / 8.0;



// Koeffizienten des Kettenbruchs K_6(v) für erf_d(x), x in D=[1.75,2.375]:
 real q_erfd_a[7] = {0.0, 
			  5956852962532043.0 / 288230376151711744.0,
			  7505999379013090.0 / 4503599627370496.0,
			  6365087486601060.0 / 18014398509481984.0,
			  5887704799239273.0 / 36028797018963968.0,
			  7015755622527586.0 / 72057594037927936.0,
			  4964207990205884.0 / 72057594037927936.0 };
 real q_erfd_b[7] = { 8965065963705828.0 / 9007199254740992.0, 
			   4503599627373934.0 / 2251799813685248.0,
			   -7205759399286829.0 / 36028797018963968.0,
			   -6797885509019941.0 / 36028797018963968.0,
			   -6316712874823321.0 / 36028797018963968.0,
			   -6072502419332079.0 / 36028797018963968.0,
                           -7727894617828847.0 / 72057594037927936.0 };
 real q_erfD_x0 = 2.0;



// Koeffizienten des Kettenbruchs K_6(v) für erf_e(x), x in E=[2.375,3]:
 real q_erfe_a[7] = {0.0, 
			  5022781464638288.0 / 2305843009213693952.0,
			  5441849549580400.0 / 2251799813685248.0,
			  8993989991602655.0 / 18014398509481984.0,
			  8067497530085489.0 / 36028797018963968.0,
			  4712838785836962.0 / 36028797018963968.0,
			  7375961764114477.0 / 72057594037927936.0 };
 real q_erfe_b[7] = { 9003533756832747.0 / 9007199254740992.0,
			   5629499534241323.0 / 2251799813685248.0,
			   -6211861511081728.0 / 36028797018963968.0,
			   -5986983176433140.0 / 36028797018963968.0,
			   -5726045470007288.0 / 36028797018963968.0,
			   -5705407821683595.0 / 36028797018963968.0,
                           8952312918824915.0 / 576460752303423488.0 };
 real q_erfE_x0 = 2.5;


// Koeffizienten des Kettenbruchs K_6(v) für erf_f(x), x in F=[3,3.75]:
 real q_erff_a[7] = {0.0, 
			  6374518008904885.0 / 1180591620717411303424.0,
			  4972724551559426.0 / 1125899906842624.0,
			  8045499210065328.0 / 9007199254740992.0,
			  7016882254363820.0 / 18014398509481984.0,
			  7988304768614147.0 / 36028797018963968.0,
			  5838430456911509.0 / 36028797018963968.0 };
 real q_erff_b[7] = { 9007192561505886.0 / 9007199254740992.0,
			   7881299349490147.0 / 2251799813685248.0,
			   -4758518108168450.0 / 36028797018963968.0,
			   -4693149470472531.0 / 36028797018963968.0,
			   -4599925404826480.0 / 36028797018963968.0,
			   -8884340027850443.0 / 72057594037927936.0,
			   -5699223430810236.0 / 18014398509481984.0 };
 real q_erfF_x0 = 3.5;



// Koeffizienten des Kettenbruchs K_6(v) für erf_g(x), x in G=[3.75,4.75]:
 real q_erfg_a[7] = {0.0, 
			  4879222820744540.0 / 302231454903657293676544.0,
			  7154159002556670.0 / 1125899906842624.0,
			  5755708538139200.0 / 4503599627370496.0,
			  4978596050810876.0 / 9007199254740992.0,
			  5586798556671249.0 / 18014398509481984.0,
			  6657329962942854.0 / 36028797018963968.0 };
 real q_erfg_b[7] = { 9007199238072502.0 / 9007199254740992.0, 
			   4785074640987249.0 / 1125899906842624.0,
			   -8032812027734944.0 / 72057594037927936.0,
			   -7979116032131355.0 / 72057594037927936.0,
			   -7964759705987174.0 / 72057594037927936.0,
			   -8729599863782987.0 / 72057594037927936.0,
                           -7179339039454358.0 / 36028797018963968.0 };
 real q_erfG_x0 = 4.25;


// Koeffizienten des Kettenbruchs K_5(v) für erf_h(x), x in H=[4.75,6]:
 real q_erfh_a[6] = {0.0, 
			  6341197935625119.0 / 19807040628566084398385987584.0,
			  5613442778568508.0 / 562949953421312.0,
			  4552589816227466.0 / 2251799813685248.0,
			  8205861162766164.0 / 9007199254740992.0,
			  8075984651153722.0 / 18014398509481984.0 };
 real q_erfh_b[6] = { 9007199254740728.0 / 9007199254740992.0,
			   6053615022849276.0 / 1125899906842624.0,
			   -6244191011536391.0 / 72057594037927936.0,
			   -7376009458672982.0 / 72057594037927936.0,
			   -8434339137924272.0 / 36028797018963968.0,
			   -8997419601100414.0 / 18014398509481984.0 };
 real q_erfH_x0 = 5.375;

// Koeffizienten des Kettenbruchs K_7(v) für erfc_b(x), x in B=[0.5,1.125]:
 real q_erfcb_a[8] = { 0.0, 
			    -8941152809329845.0 / 18014398509481984.0, 
			    +5468237828807696.0 / 9007199254740992.0, 
			    +4626506210788252.0 / 36028797018963968.0, 
                            +4856189485307208.0 / 36028797018963968.0,
                            -8449587852971314.0 / 576460752303423488.0, 
                            +5970611890329877.0 / 9007199254740992.0,
                            -6516948850318163.0 / 18014398509481984.0 };
 real q_erfcb_b[8] = { +7204754410611630.0 / 36028797018963968.0, 
			    +8162774324608929.0 / 9007199254740992.0, 
			    -8963732877768615.0 / 36028797018963968.0, 
			    -5910144016410489.0 / 18014398509481984.0, 
                            +6455405233749394.0 / 144115188075855872.0,
                            +6620879892924269.0 / 18014398509481984.0,
                            -8703271419936650.0 / 18014398509481984.0,
                            +6316686628627470.0 / 18014398509481984.0 };
 real q_erfcB_x0 = 29.0 / 32.0; // Entwicklungspunkt x0;

// Koeffizienten des Kettenbruchs K_6(v) für erfc_c(x), x in C=[1.125,1.5]:
 real q_erfcc_a[7] = { 0.0, 
                            -6137857706384142.0 / 36028797018963968.0,
                            8678811781915844.0 / 9007199254740992.0,
                            7734682893505984.0 / 36028797018963968.0,
			    8140095025972921.0 / 72057594037927936.0,
			    7136373987818015.0 / 144115188075855872.0,
                            8740495912215832.0 / 72057594037927936.0 };
 real q_erfcc_b[7] = { 7469479708966975.0 / 144115188075855872.0,
			    6192449487634288.0 / 4503599627370496.0,
			    -8569011183391803.0 / 36028797018963968.0,
			    -8195809092100585.0 / 36028797018963968.0,
			    -5840597017224982.0 / 36028797018963968.0,
			    -6135592123804005.0 / 18014398509481984.0,
                            4642496470382871.0 / 18014398509481984.0 };

 real q_erfcC_x0 = 11.0 / 8.0; // Entwicklungspunkt x0;


// Koeffizienten des Kettenbruchs K_7(v) für erfc_d(x), x in D=[1.5,2]:
 real q_erfcd_a[8] = { 0.0, 
			    -6087508499572704.0 / 144115188075855872.0,
			    6432876030241406.0 / 4503599627370496.0,
			    5531627034248222.0 / 18014398509481984.0,
			    5213931368452889.0 / 36028797018963968.0,
			    6175039604157953.0 / 72057594037927936.0,
			    4762514293956138.0 / 72057594037927936.0,
                            6299051486506706.0 / 288230376151711744.0 };
 real q_erfcd_b[8] = { 5977537255259611.0 / 576460752303423488.0,
			    8162774324609012.0 / 4503599627370496.0,
			    -7619581502661690.0 / 36028797018963968.0,
			    -7137110857601347.0 / 36028797018963968.0,
			    -6472082438195355.0 / 36028797018963968.0,
			    -6547000550119455.0 / 36028797018963968.0,
			    -8803256530143517.0 / 72057594037927936.0,
                            5300297812696310.0 / 72057594037927936.0 };

 real q_erfcD_x0 = 29.0 / 16.0; // Entwicklungspunkt x0;


// Koeffizienten des Kettenbruchs K_5(v) für erfc_e(x), x in E=[2,3.5];
// erfcE(x) '=' exp(-x^2)*K_5(v),  v = 1/(x-x0),  x0 = 11/4 = 2.75;
 real q_erfce_a[6] = { 0.0, 
			    -4556752015261849.0 / 72057594037927936.0,
			    8723162825651037.0 / 2305843009213693952.0,
			    5000733876586494.0 / 1152921504606846976.0,
			    4990268916315754.0 / 1152921504606846976.0,
			    4789667087501064.0 / 1152921504606846976.0 };
 real q_erfce_b[6] = { 6977412357105623.0 / 36028797018963968.0,
			    5628596857670309.0 / 18014398509481984.0,
			    4506999066609570.0 / 18014398509481984.0,
			    7773639203111212.0 / 36028797018963968.0,
			    6946708607281322.0 / 36028797018963968.0,
                            6182877093388186.0 / 36028797018963968.0 };

 real q_erfcE_x0 = 11.0 / 4.0; // Entwicklungspunkt x0;


// Koeffizienten des Kettenbruchs K_5(v) für erfc_f(x), x in F=[3.5,7];
// erfc_f(x) '=' exp(-x^2)*K_5(v),  v = 1/(x-x0),  x0 = 21/4 = 5.25;
 real q_erfcf_a[6] = { 0.0, 
			    -5604767832290715.0 / 288230376151711744.0,
			    4548728150092866.0 / 9223372036854775808.0,
			    7130411629531157.0 / 9223372036854775808.0,
			    8684543622600523.0 / 9223372036854775808.0,
                            4828812156959036.0 / 4611686018427387904.0 };
 real q_erfcf_b[6] = { 7610199617652478.0 / 72057594037927936.0,
			    6529597086937314.0 / 36028797018963968.0,
			    5979892434108673.0 / 36028797018963968.0,
			    5557167414035873.0 / 36028797018963968.0,
			    5216693379591615.0 / 36028797018963968.0,
                            4748695128494333.0 / 36028797018963968.0 };

 real q_erfcF_x0 = 21.0 / 4.0; // Entwicklungspunkt x0;


// Koeffizienten des Kettenbruchs K_5(v) für erfc_g(x), x in G=[7,14];
// erfc_g(x) '=' exp(-x^2)*K_5(v),  v = 1/(x-x0),  x0 = 21/2 = 10.5;
 real q_erfcg_a[6] = { 0.0, 
			    -5821414752945478.0 / 1152921504606846976.0,
			    5609968403206958.0 / 147573952589676412928.0,
			    5204789631164748.0 / 73786976294838206464.0,
			    7271430635499163.0 / 73786976294838206464.0,
			    4547303334095208.0 / 36893488147419103232.0 };
 real q_erfcg_b[6] = { 7708995192510915.0 / 144115188075855872.0, 
			    6772097404638088.0 / 72057594037927936.0,
			    6600825662106980.0 / 72057594037927936.0,
			    6443089761948616.0 / 72057594037927936.0,
			    6296889991751339.0 / 72057594037927936.0,
                            6037470072874453.0 / 72057594037927936.0 };
 real q_erfcG_x0 = 21.0 / 2.0; // Entwicklungspunkt x0;


// Koeffizienten des Kettenbruchs K_4(v) für erfc_h(x), x in H=[14,26.5];
// erfc_h(x) '=' exp(-x^2)*K_4(v),  v = 1/(x-x0),  x0 = 41/2 = 20.5;
 real q_erfch_a[5] = { 0.0, 
			    -6169263907284333.0 / 4611686018427387904.0,
			    6544385104732664.0 / 2361183241434822606848.0,
			    6408896217682354.0 / 1180591620717411303424.0,
			    4712112567939038.0 / 590295810358705651712.0 };
 real q_erfch_b[5] = { 7923111531207061.0 / 288230376151711744.0, 
			    7005123496472257.0 / 144115188075855872.0,
			    6956103929323301.0 / 144115188075855872.0,
			    6908197448811189.0 / 144115188075855872.0,
			    6831084668903765.0 / 144115188075855872.0 };
 real q_erfcH_x0 = 41.0 / 2.0; // Entwicklungspunkt x0 = 20.5;

#else
/* ----    worst case relative error bound for q_erf and q_erfc   ---- */         
/*    eps(q_erf)    = 2.8452e-15                                       */
/*        q_erfm    = 1 - eps(q_erf) = 9.999999999999969e-001          */
   real   q_erfm    = 9007199254740964.0 /  9007199254740992.0;
/*        q_erfp    = 1 + eps(q_erf) = 1.000000000000003e+000          */
   real   q_erfp    = 4503599627370510.0 /  4503599627370496.0;      

/*    eps(q_erfc)   = 6.1641e-15                                       */
/*        q_efcm    = 1 - eps(q_erfc) = 9.999999999999936e-001         */
   real   q_efcm    = 9007199254740934.0 /  9007199254740992.0;
/*        q_efcp    = 1 + eps(q_erfc) = 1.000000000000006e+000         */
   real   q_efcp    = 4503599627370525.0 /  4503599627370496.0;

...
/* CVS $Id: j_asnh.cpp,v 1.5 2008/01/23 08:39:36 cxsc Exp $ */
       ...
       if (Inf(x)<0)
        {
          if (Inf(x)>-q_minr)
            ...
            {
              Inf(res)=q_asnh(Inf(x));
              Sup(res)=Inf(res)*q_asnm;
              Inf(res)*=q_asnp;

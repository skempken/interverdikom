...
// Berechnet Näherungen für erf(x) in:  0 <= x <= 0.5;
// Rel. Fehlerschranke in 1.97193e-308 <= x <= 0.5 ist:  6.36761e-16;
{
    real y(0),v;
    int ex = expo(x);
...
//  Berechnet für die Intervallfunktion Näherungen für 
...
// Rel. Fehlerschranke in diesem Bereich: 5.4009e-16;
{
    real y,v;

...
/* CVS $Id: dot.cpp,v 1.16 2008/01/23 08:39:30 cxsc Exp $ */
...
//----------------------------------------------------------------------
// global verfÅgbare Dotprecision Variablen
//
...
dotprecision::dotprecision(void) throw() : akku(new a_btyp[A_LENGTH])
{
...
bool operator <=(const dotprecision &a,const dotprecision &b) throw()   // Uebernommen aus dot.cpp "testlessequal"
{
   int res = true, cont;

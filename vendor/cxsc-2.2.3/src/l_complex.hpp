...
*/
/* CVS $Id: l_complex.hpp,v 1.7 2008/01/23 08:39:31 cxsc Exp $ */

#ifndef L_COMPLEX_HPP
#define L_COMPLEX_HPP
...
// ----------------- Others --------------------------------------------------
    ...
    l_complex conj(const l_complex& lc) // returning the conjugated value
                        { return l_complex(lc.re,-lc.im); }

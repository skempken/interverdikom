...
/* CVS $Id: l_cimath.hpp,v 1.6 2008/01/23 08:39:31 cxsc Exp $ */
...
#ifndef L_CIMATH_HPP_INCLUDED
#define L_CIMATH_HPP_INCLUDED
...
namespace cxsc{
    ...
    l_interval Atan(const l_interval& y, const l_interval& x); // Loeschen!!!!

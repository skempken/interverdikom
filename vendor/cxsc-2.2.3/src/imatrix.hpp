...
/* CVS $Id: imatrix.hpp,v 1.24 2008/05/28 17:58:39 cxsc Exp $ */
...
//======================== Vector / Vector ========================
	...
	INLINE void accumulate(idotprecision &dp, const imatrix_subv & rv1, const imatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
...
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(idotprecision &dp, const ivector_slice & sl1, const imatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(idotprecision &dp, const imatrix_subv & rv1, const ivector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
	...
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const imatrix_subv & rv1, const imatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
...
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const ivector_slice & sl1, const imatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const imatrix_subv & rv1, const ivector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
...
// real
	...
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(idotprecision &dp, const rmatrix_subv & rv1, const imatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
...
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(idotprecision &dp, const rvector_slice & sl1, const imatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
	...
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(idotprecision &dp, const imatrix_subv & rv1, const rmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
...
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(idotprecision &dp, const imatrix_subv & rv1, const rvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
	...
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const rmatrix_subv & rv1, const imatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
...
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const rvector_slice & sl1, const imatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
	...
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const imatrix_subv & rv1, const rmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
...
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const imatrix_subv & rv1, const rvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
...
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const cvector & rv1, const imatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const cvector_slice & sl1, const imatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
...
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const imatrix_subv & rv1, const cvector &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const imatrix_subv & rv1, const cvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
...
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const civector_slice & sl1, const imatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
...
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const imatrix_subv & rv1, const civector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();

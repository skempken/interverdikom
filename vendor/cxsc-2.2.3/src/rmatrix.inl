...
/* CVS $Id: rmatrix.inl,v 1.15 2008/05/19 13:19:07 cxsc Exp $ */
...
INLINE rmatrix::rmatrix(const rvector_slice &v) throw():lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	...
	INLINE rmatrix_subv rmatrix_slice::operator [](const int &i)
#if(IndCheck)
		throw(ERROR_RMATRIX_ROW_OR_COL_NOT_IN_MAT)
#else
	throw()
	...
	INLINE rmatrix_subv rmatrix_slice::operator [](const cxscmatrix_column &i)
#if(IndCheck)
		throw(ERROR_RMATRIX_ROW_OR_COL_NOT_IN_MAT)
#else
	throw()
...
// the following is generated from .hpp
	...
	INLINE void accumulate(dotprecision &dp, const rmatrix_subv & rv1, const rmatrix_subv &rv2)
#if(IndCheck)
...
#endif
	{ _vmvaccu(dp,rv2,rv1); }
	INLINE void accumulate(idotprecision &dp, const rmatrix_subv & rv1, const rmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
...
#endif
	{ _vmvaccu(dp,rv2,rv1); }
	INLINE void accumulate(cdotprecision &dp, const rmatrix_subv & rv1, const rmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
...
#endif
	{ _vmvaccu(dp,rv2,rv1); }
	INLINE void accumulate(cidotprecision &dp, const rmatrix_subv & rv1, const rmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
...
#endif
	{ _vmvaccu(dp,rv2,rv1); }
	INLINE void accumulate(dotprecision &dp,const rvector_slice &sl,const rmatrix_subv &sv)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
#endif
	{ _vmvaccu(dp,rvector(sl),sv); }
	INLINE void accumulate(cdotprecision &dp, const rvector_slice & sl1, const rmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
	...
	INLINE void accumulate(idotprecision &dp, const rvector_slice & sl1, const rmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
#endif
	{ _vmvaccu(dp,rvector(sl1),rv2); }
	INLINE void accumulate(cidotprecision &dp, const rvector_slice & sl1, const rmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
#endif
	{ _vmvaccu(dp,rvector(sl1),rv2); }
	INLINE void accumulate(dotprecision &dp,const rmatrix_subv &mv,const rvector_slice &vs)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
#endif
	{ _vmvaccu(dp,rvector(vs),mv); }
	INLINE void accumulate(cdotprecision &dp, const rmatrix_subv & rv1, const rvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
	...
	INLINE void accumulate(idotprecision &dp, const rmatrix_subv & rv1, const rvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
#endif
	{ _vmvaccu(dp,rvector(sl2),rv1); }
	INLINE void accumulate(cidotprecision &dp, const rmatrix_subv & rv1, const rvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()

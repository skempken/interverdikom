...
/* CVS $Id: rvector.hpp,v 1.19 2008/05/28 17:58:40 cxsc Exp $ */
...
template <class MV,class V> friend  MV &_mvvsetre(MV &v,const V &rv)
 ...
 template <class V,class MS,class E> friend 	 E _vmslimult(const V &v,const MS &ms)
	...
	INLINE rvector () throw();
	//! Constructor of class rvector
	explicit INLINE rvector(const int &i) throw();
#ifdef OLD_CXSC
	//! Constructor of class rvector
	explicit INLINE rvector(const class index &i) throw(); // for backwards compatibility
#endif
	//! Constructor of class rvector
...
#endif
	//! Constructor of class rvector
	INLINE rvector(const rmatrix_subv &) throw();
	//! Constructor of class rvector
	explicit INLINE rvector(const real &) throw();
	//! Constructor of class rvector
...
#endif
	//! Constructor of class rvector
	INLINE rvector(const rvector_slice &rs) throw();
	//! Constructor of class rvector
	INLINE rvector(const rvector &v) throw();
	//! Implementation of standard assigning operator
	INLINE rvector &operator =(const rvector &rv) throw();
	//! Implementation of standard assigning operator
	INLINE rvector &operator =(const rvector_slice &sl) throw();
	//! Implementation of standard assigning operator
	INLINE rvector &operator =(const real &r) throw();
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE rvector &operator =(const rmatrix_subv &) throw();
	...
	friend INLINE int Lb(const rvector &rv) throw() { return rv.l; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const rvector &rv) throw() { return rv.u; }
	//! Returns the dimension of the vector
        friend INLINE int VecLen(const rvector &rv) throw() { return rv.size; }
	//! Sets the lower bound of the vector
	friend INLINE rvector &SetLb(rvector &rv, const int &l) throw() { rv.l=l; rv.u=l+rv.size-1; return rv; }
	//! Sets the upper bound of the vector
	friend INLINE rvector &SetUb(rvector &rv, const int &u) throw() { rv.u=u; rv.l=u-rv.size+1; return rv; }
	...
	INLINE rvector & operator ()() throw() { return *this; }
...
//------------------------- Templates -------------------------------------------
 ...
 template <class VS1,class VS2,class E> friend 	 E _vsvslimult(const VS1 & sl1, const VS2 &sl2)
	...
	explicit INLINE rvector_slice(rvector &a, const int &lb, const int &ub) throw():dat(a.dat),l(a.l),u(a.u),size(ub-lb+1),start(lb),end(ub) { }
	//! Constructor of class rvector_slice
	explicit INLINE rvector_slice(rvector_slice &a, const int &lb, const int &ub) throw():dat(a.dat),l(a.l),u(a.u),size(ub-lb+1),start(lb),end(ub) { }
	public: 
	//! Constructor of class rvector_slice
	INLINE rvector_slice(const rvector_slice &a) throw():dat(a.dat),l(a.l),u(a.u),size(a.size),start(a.start),end(a.end) { }
	public:
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE rvector_slice & operator =(const real &r) throw();
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE rvector_slice &operator =(const rmatrix_subv &) throw();
...
#endif
	//! Returns the lower bound of the vector
	friend INLINE int Lb(const rvector_slice &sl) throw() { return sl.start; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const rvector_slice &sl) throw() { return sl.end; }
	//! Returns the dimension of the vector
        friend INLINE int VecLen(const rvector_slice &sl) throw() { return sl.end-sl.start+1; }
	//! Operator for accessing the single elements of the vector
	INLINE real & operator [](const int &i)
#if(IndCheck)
	throw(ERROR_RVECTOR_ELEMENT_NOT_IN_VEC);
...
#endif
	//! Operator for accessing the whole vector
	INLINE rvector_slice & operator ()() throw() { return *this; }
	//! Operator for accessing a part of the vector
	INLINE rvector_slice operator ()(const int &i)
#if(IndCheck)
	throw(ERROR_RVECTOR_SUB_ARRAY_TOO_BIG);
...
//======================== Vector Functions =============================
	...
	INLINE rvector _rvector(const real &r) throw(); 
//	INLINE rvector _rvector(const rmatrix &m) throw(ERROR_RMATRIX_TYPE_CAST_OF_THICK_OBJ);
//	INLINE rvector _rvector(const rmatrix_slice &sl) throw(ERROR_RMATRIX_TYPE_CAST_OF_THICK_OBJ);

	//! Resizes the vector
	INLINE void Resize(rvector &rv) throw();
	//! Resizes the vector
	...
	INLINE rvector abs(const rvector &rv) throw();
	//! Returns the absolute value of the vector
	INLINE rvector abs(const rvector_slice &sl) throw();
	//! Implementation of standard negation operation
	INLINE bool operator !(const rvector &rv) throw();
	//! Implementation of standard negation operation
	INLINE bool operator !(const rvector_slice &sl) throw();

//======================= Vector / Scalar ===============================

	//! Implementation of multiplication operation
	INLINE rvector operator *(const rvector &rv, const real &s) throw();
	//! Implementation of multiplication operation
	INLINE rvector operator *(const rvector_slice &sl, const real &s) throw();
	//! Implementation of multiplication operation
	INLINE rvector operator *(const real &s, const rvector &rv) throw();
	//! Implementation of multiplication operation
	INLINE rvector operator *(const real &s, const rvector_slice &sl) throw();
	//! Implementation of multiplication and allocation operation
	INLINE rvector &operator *=(rvector &rv,const real &r) throw();
...
//======================= Vector / Vector ===============================
	...
	INLINE void accumulate(dotprecision &dp, const rvector & rv1, const rvector &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(dotprecision &dp, const rvector & rv1, const rmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(dotprecision &dp, const rmatrix_subv & rv1, const rvector &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(dotprecision &dp,const rvector_slice &sl,const rvector &rv)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(dotprecision &dp,const rvector &rv,const rvector_slice &sl)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(dotprecision &dp, const rvector_slice & sl1, const rvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
	...
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(idotprecision &dp, const rvector & rv1, const rvector &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(idotprecision &dp, const rvector & rv1, const rmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(idotprecision &dp, const rmatrix_subv & rv1, const rvector &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(idotprecision &dp,const rvector_slice &sl,const rvector &rv)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(idotprecision &dp,const rvector &rv,const rvector_slice &sl)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(idotprecision &dp, const rvector_slice & sl1, const rvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
	...
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cdotprecision &dp, const rvector & rv1, const rvector &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cdotprecision &dp, const rvector & rv1, const rmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cdotprecision &dp, const rmatrix_subv & rv1, const rvector &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cdotprecision &dp,const rvector_slice &sl,const rvector &rv)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cdotprecision &dp,const rvector &rv,const rvector_slice &sl)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cdotprecision &dp, const rvector_slice & sl1, const rvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
	...
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const rvector & rv1, const rvector &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const rvector & rv1, const rmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const rmatrix_subv & rv1, const rvector &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp,const rvector_slice &sl,const rvector &rv)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp,const rvector &rv,const rvector_slice &sl)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
#endif
	//! The accurate scalar product of the last two arguments added to the value of the first argument
	INLINE void accumulate(cidotprecision &dp, const rvector_slice & sl1, const rvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM);
#else
	throw();
	...
	INLINE const rvector &operator +(const rvector &rv) throw();
	//! Implementation of positive sign operation
	INLINE rvector operator +(const rvector_slice &sl) throw();
	...
	INLINE bool operator ==(const rvector &rv1, const rvector &rv2) throw();
	//! Implementation of standard equality operation
	INLINE bool operator ==(const rvector_slice &sl1, const rvector_slice &sl2) throw();
	//! Implementation of standard equality operation
	INLINE bool operator ==(const rvector_slice &sl, const rvector &rv) throw();
	//! Implementation of standard equality operation
	INLINE bool operator ==(const rvector &rv, const rvector_slice &sl) throw();
	...
	INLINE std::ostream &operator <<(std::ostream &s, const rvector &rv) throw();
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &o, const rvector_slice &sl) throw();
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s, rvector &rv) throw();
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s, rvector_slice &rv) throw();

...
/* CVS $Id: l_interval.hpp,v 1.22 2008/05/28 17:58:40 cxsc Exp $ */
...
//      friend inline l_interval_Sup Sup (l_interval &)  throw();
    ...
    // Calculating expo(x[k]) of the greatest |x[k]|.
      ...
      friend l_interval Ln2_l_interval() throw();     // ln(2)   ; Blomquist,11.09.06;
      //! Enclosure-Interval for \f$ \ln 10 \f$
      friend l_interval Ln10_l_interval() throw();  // ln(10)  ; Blomquist,11.09.06;
      //! Enclosure-Interval for \f$ \frac{1}{\ln 10} \f$
      friend l_interval Ln10r_l_interval() throw(); // 1/ln(10); Blomquist,11.09.06;
      //! Enclosure-Interval for \f$ \frac{\pi}{4} \f$
      friend l_interval Pid4_l_interval() throw();  // Pi/4    ; Blomquist,11.09.06;
      //! Enclosure-Interval for \f$ \sqrt{2} \f$
      friend l_interval Sqrt2_l_interval() throw(); // sqrt(2) ; Blomquist,11.09.06;

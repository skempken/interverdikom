...
/* CVS $Id: cmatrix.inl,v 1.14 2008/01/23 08:39:29 cxsc Exp $ */
...
#endif
	{ _vmvaccu(dp,rv2,rv1); }
	INLINE void accumulate(cdotprecision &dp, const cvector_slice & sl1, const cmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
#endif
	{ _vmvaccu(dp,cvector(sl1),rv2); }
	INLINE void accumulate(cdotprecision &dp, const cmatrix_subv & rv1, const cvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
#endif
	{ _vmvaccu(dp,cvector(sl2),rv1); }
...
#endif
	{ _vmvaccu(dp,rv2,rv1); }
	INLINE void accumulate(cidotprecision &dp, const cvector_slice & sl1, const cmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
#endif
	{ _vmvaccu(dp,cvector(sl1),rv2); }
	INLINE void accumulate(cidotprecision &dp, const cmatrix_subv & rv1, const cvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
...
//  real
...
#endif
	{ _vmvaccu(dp,rv2,rv1); }
	INLINE void accumulate(cdotprecision &dp, const rvector_slice & sl1, const cmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
	...
	INLINE void accumulate(cdotprecision &dp, const cmatrix_subv & rv1, const rvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
...
#endif
	{ _vmvaccu(dp,rv2,rv1); }
	INLINE void accumulate(cidotprecision &dp, const rvector_slice & sl1, const cmatrix_subv &rv2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()
#endif
	{ _vmvaccu(dp,rvector(sl1),rv2); }
	INLINE void accumulate(cidotprecision &dp, const cmatrix_subv & rv1, const rvector_slice &sl2)
#if(IndCheck)
	throw(OP_WITH_WRONG_DIM)
#else
	throw()

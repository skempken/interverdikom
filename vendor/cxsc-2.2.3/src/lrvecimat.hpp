...
/* CVS $Id: lrvecimat.hpp,v 1.13 2008/01/23 08:39:31 cxsc Exp $ */

// Here are definitions for l_rvector x imatrix-Functions
#ifndef _CXSC_LRVECIMAT_HPP_INCLUDED
#define _CXSC_LRVECIMAT_HPP_INCLUDED

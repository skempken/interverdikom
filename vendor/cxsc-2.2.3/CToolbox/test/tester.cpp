...
/******************** special cases (begin) ********************/
  if (strcmp(argFeld[1], "hess_ex.out") == 0)
  {
  ...
  if (strcmp(argFeld[1], "lop_ex.out1") == 0)
  {
    while (eindat1.peek()!='I' && !eindat1.eof())
    {
      eindat1.get();
  ...
  if (strcmp(argFeld[1], "lop_ex.out2") == 0)
  {
    while (eindat1.peek()!='I' && !eindat1.eof())
    {
      eindat1.get();
...
/******************** special cases (begin) ********************/
  ...
  if (strcmp(argFeld[2], "hess_ex.vgl") == 0)
  {
  ...
  if (strcmp(argFeld[2], "lop_ex.vgl1") == 0)
  {
    while (eindat2.peek()!='I' && !eindat2.eof())
    {
      eindat2.get();
  ...
  if (strcmp(argFeld[2], "lop_ex.vgl2") == 0)
  {
    while (eindat2.peek()!='I' && !eindat2.eof())
    {
      eindat2.get();

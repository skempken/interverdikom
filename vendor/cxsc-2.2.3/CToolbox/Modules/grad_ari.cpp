...
/* CVS $Id: grad_ari.cpp,v 1.3 2008/01/23 08:39:21 cxsc Exp $ */
...
GradType operator/ ( const GradType& u, const real& b )
  { return u / _interval(b); }    // Can propagate 'division by zero' error
                                  //---------------------------------------
GradType operator+ ( const real& a, const GradType& v )
  { return _interval(a) + v; }
...
GradType operator/ ( const real& a, const GradType& v )
  { return _interval(a) / v; }    // Can propagate 'division by zero' error
                                  //---------------------------------------
